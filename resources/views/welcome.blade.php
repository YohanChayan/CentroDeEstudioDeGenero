                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="card-body md-12">
                                ...
                                <p class="card-text"><a href="{{ route('Otra-Ventana-Podcast') }}" class="text-dark"><small class="text-muted pe-2" style="font-family: 'Filson Pro', sans-serif;">Ver todos los podcast</small><i class="fa fa-arrow-right pe-4"></i></a> 
