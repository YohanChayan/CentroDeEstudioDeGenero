            ...
            <div class="row my-4">
                ...
                <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                    ...
                    <div class="bg-white shadow-1-strong d-flex align-items-center justify-content-center mb-4 mx-auto"
                        ...
                        <img src="<?php echo e(asset('img/CEG.png')); ?>" width="100%"alt=""
                            loading="lazy" />
                    </div>
                ...
                <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <a href="<?php echo e(route('welcome')); ?>" class="text-white" style="font-family: 'Filson Pro', sans-serif;"><i class="fa fa-map-pin pe-3"></i>Inicio</a>
                        </li>
                        <li class="mb-2">
                            <a href="<?php echo e(route('welcome')); ?>" class="text-white" style="font-family: 'Filson Pro', sans-serif;"><i class="fa fa-map-pin pe-3"></i>Quiénes somos</a>
                        </li>
                        <li class="mb-2">
                        ...
                        <li class="mb-2">
                            <a href="<?php echo e(route('podcast.index')); ?>" class="text-white" style="font-family: 'Filson Pro', sans-serif;"><i class="fab fa-spotify pe-3"></i>Otra Ventana (Podcast)</a>
                        </li>
                        <li class="mb-2">
                            <a href="<?php echo e(route('centrodocumentacion.index')); ?>" class="text-white" style="font-family: 'Filson Pro', sans-serif;"><i class="fas fa-server pe-3"></i>Centro de Documentación</a>
                        </li>
                        <li class="mb-2">
                            <a href="<?php echo e(route('encuestas.index')); ?>" class="text-white" style="font-family: 'Filson Pro', sans-serif;"><i class="fas fa-server pe-3"></i>Encuestas</a>
                        </li>
                        <li class="mb-2">
