            ...
            <div class="row my-4">
                ...
                <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2">
                            <a href="<?php echo e(route('Otra-Ventana-Podcast')); ?>" class="text-white" style="font-family: 'Filson Pro', sans-serif;"><i class="fab fa-spotify pe-3"></i>Otra Ventana (Podcast)</a>
                        </li>
                        <li class="mb-2">
                            <a href="<?php echo e(route('Centro-de-Documentacion')); ?>" class="text-white" style="font-family: 'Filson Pro', sans-serif;"><i class="fas fa-server pe-3"></i>Centro de Documentación</a>
                        </li>
                        <li class="mb-2">
                            <a href="<?php echo e(route('Encuestas')); ?>" class="text-white" style="font-family: 'Filson Pro', sans-serif;"><i class="fas fa-server pe-3"></i>Encuestas</a>
                        </li>
                        <li class="mb-2">
